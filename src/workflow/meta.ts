 ...
 *
 * PORTED from tintinweb/pi-subagents `src/workflow/meta.ts` (MIT, commit
 * history upstream; clone at `.scratch/pi-subagents/`, gitignored). Ported
 * near-verbatim — provenance kept in this header per the v0.6 issue-12
 * honesty ruling; see the README acknowledgement.
 *
 ...
 * workflows nor produce a parser error when named. (Consumed by issue 13's
